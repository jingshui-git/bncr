...
## 免责声明
> 任何用户在使用由 jingshui（以下简称「本团队」）研发的 Nodejs （js脚本）代码（以下简称「jingshui.js」）前，请您仔细阅读并透彻理解本声明。您可以选择不使用jingshui.js，若您一旦使用jingshui.js，您的使用行为即被视为对本声明全部内容的认可和接受。  
...
3. 您承诺秉着合法、合理的原则使用jingshui.js，不利用js进行任何违法、侵害他人合法利益等恶意的行为，亦不将js运用于任何违反我国法律法规的 Web 平台。  
...
6. 任何单位或个人在阅读本免责声明后，应在法律所允许的范围内进行合法的发布、传播和使用jingshui.js等行为，若违反本免责声明条款或违反法律法规所造成的法律责任(包括但不限于民事赔偿和刑事责任），由违约者自行承担。
